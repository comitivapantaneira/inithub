...
const ProgressInitiative = () => {
  ...
  useEffect(() => {
    const foundInitiative = Initiatives.find(
      initiative => initiative.id === id && initiative.assignedToId === userId
    );
  ...
  if (!initiative) return <div>Carregando...</div>;
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-sm text-gray-500">
                    ...
                    <span>Designada para <strong>{initiative.assignedTo?.name}</strong></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <UpdatesTimeline
          ...
          onRequestAdd={() => setIsAddingStep(true)}
